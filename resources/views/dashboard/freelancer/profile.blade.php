    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="lg:col-span-2 flex flex-col gap-5">
            ...
            <div class="bg-white rounded-[18px] border border-slate-200 animate-fadeUp-1">
                ...
                <div class="px-7 py-6">
                    {{-- Flash message 'success' sudah ditangani otomatis oleh x-flash di layouts/dashboard --}}
            ...
            <div class="bg-white rounded-[18px] border border-slate-200 animate-fadeUp-2">
                ...
                <div class="px-7 py-6">
                    {{-- Flash message 'error' sudah ditangani otomatis oleh x-flash di layouts/dashboard --}}
