...
@section('styles')
    ...
    <style>
        .filter-tab-link { padding: 8px 18px; border-radius: 9999px; border: 1.5px solid #e2e8f0; background-color: #ffffff; color: #64748b; font-weight: 700; font-size: 12.5px; transition: all 0.2s; }
        .filter-tab-link.active { border-color: #0f766e; background-color: #0f766e; color: #ffffff; box-shadow: 0 4px 12px rgba(15,118,110,0.2); }
    </style>
@endsection
