        ...
        <section class="lg:col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="{{ route('admin.orders.index') }}"
                    ...
                    <div
                        class="absolute right-0 top-0 w-24 h-24 bg-gradient-to-bl from-slate-50 to-transparent -z-10 rounded-bl-[100px] opacity-0 group-hover:opacity-100 transition-opacity">
                    </div>
                    <div
                    ...
                    <div>
                        ...
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Kelola order & status pekerjaan secara
                            real-time.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.transactions.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Transactions</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Pantau arus kas, verifikasi pembayaran &
                            refund.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.offers.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Penawaran</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Review dan pantau penawaran custom order.
                        </p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.reviews.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Ulasan & Penilaian</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Analisis sentimen dan ulasan kepuasan
                            Client.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.services.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Katalog Layanan</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Manajemen daftar layanan dan kategori aktif.
                        </p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.portofolios.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Portofolios</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Lihat portofolio publik dari para
                            freelancer.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.negotiations.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Negotiations</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Pantau dan kelola negosiasi harga antara
                            client dan freelancer.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.admins.index') }}"
                    ...
                    <div
                        class="w-11 h-11 rounded-xl bg-rose-50 text-rose-500 flex items-center justify-center text-[22px] shrink-0 group-hover:scale-110 transition-transform">
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Admin Management</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Kelola akun admin dan hak akses platform.
                        </p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.profile') }}"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-[12.5px] text-slate-400">Ubah data profil, password, dan pengaturan keamanan
                                Admin.</p>
                        </div>
                    </div>
                    <div
        ...
        <section>
            ...
            <div class="bg-white border border-slate-200 rounded-[20px] p-6 h-[calc(100%-2.5rem)] shadow-sm">
                ...
                <div class="relative pl-6 pb-6 border-l-2 border-slate-100 last:pb-0 last:border-transparent">
                    ...
                    <h3 class="text-[14px] text-slate-900 mb-1.5 font-bold -mt-1">Pantau Sengketa</h3>
                    <p class="text-[12.5px] text-slate-500 leading-relaxed">
                ...
                <div class="relative pl-6 pb-6 border-l-2 border-slate-100 last:pb-0 last:border-transparent">
                    ...
                    <ul class="text-[12.5px] text-slate-500 leading-relaxed list-disc pl-4 space-y-1.5 mt-2">
                        ...
                        <li>Pastikan status <code
                                class="bg-slate-100 px-1 rounded text-slate-600 text-[11px]">in_progress</code> hanya aktif
                            saat dibayar.</li>
