                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <button data-order-id="{{ $order->id }}" class="btn-open-order-detail w-8 h-8 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center hover:bg-indigo-500 hover:text-white transition-all">
                                        <i class="ri-eye-line"></i>
                                    </button>
                                    <button data-order-id="{{ $order->id }}" class="btn-open-order-modal w-8 h-8 rounded-lg bg-slate-100 text-slate-500 flex items-center justify-center hover:bg-[#0f766e] hover:text-white transition-all">
                                        <i class="ri-edit-line"></i>
                                    </button>
                                    <button data-order-id="{{ $order->id }}" class="btn-open-delete-order w-8 h-8 rounded-lg bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all">
...
@section('scripts')
    <script id="__ORDERS_DATA_JSON__" type="application/json">{{ base64_encode(json_encode($orders instanceof \Illuminate\Pagination\LengthAwarePaginator ? $orders->items() : $orders)) }}</script>
    <script>
        (function () {
            try {
