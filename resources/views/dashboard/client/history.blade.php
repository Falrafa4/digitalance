...
@section('content')
  <section class="animate-fadeUp">
    ...
    @if(empty($orders) || count($orders) === 0)
      <x-ui.empty-state icon="ri-history-line" title="Belum ada history"
        description="Order yang selesai/dibatalkan akan muncul di sini." actionUrl="{{ route('client.services.index') }}"
