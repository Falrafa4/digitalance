            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <a href="{{ route('client.talents.index') }}"
                    ...
                    <div
                        class="absolute right-0 top-0 w-24 h-24 bg-gradient-to-bl from-slate-50 to-transparent -z-10 rounded-bl-[100px] opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <i
                            class="ri-user-search-line text-[50px] text-slate-100/50 -rotate-12 translate-x-4 -translate-y-4"></i>
                    </div>
                    <div
                ...
                <a href="{{ route('client.results.index') }}"
                    ...
                    <div>
                        <h3
                            class="font-display font-bold text-[14.5px] text-slate-900 mb-1 group-hover:text-teal-700 transition-colors">
                            Hasil Kerja</h3>
                        <p class="text-[12.5px] text-slate-500 leading-relaxed">Lihat & unduh hasil pekerjaan freelancer.
                        </p>
                    </div>
                </a>
        ...
        <section>
            ...
            <div class="bg-white border border-slate-200 rounded-[20px] p-6 h-[calc(100%-2.5rem)] shadow-sm">
                ...
                <div class="mt-6 pt-5 border-t border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                        <div class="text-[11.5px] font-bold text-slate-800 uppercase tracking-wider">Digitalance Client
                        </div>
