...
@section('title', 'Profil | Digitalance')
...
@section('content')
    <div class="content-scroll flex-1 px-4 sm:px-8 py-7 overflow-y-auto">
        ...
        <div class="mb-8 animate-fadeUp">
            <h1 class="font-display text-[2.1rem] font-extrabold text-slate-900">Profil Saya</h1>
            ...
            <div class="lg:col-span-1">
                <div
                    ...
                    <div class="relative mb-4">
                        <x-avatar :user="$user" role="client" :size="128" class="w-24 h-24 rounded-[18px] object-cover border-4 border-white shadow-teal-md" alt="{{ $user->name }}" />
                    </div>
                    ...
                    <span
                        class="inline-flex items-center gap-1.5 mt-2 px-3 py-1 bg-blue-50 text-blue-600 text-[11px] font-bold rounded-full">
                    ...
                    <div class="px-7 py-6">
                        ...
                        <form action="{{ route('client.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                                ...
                                <div class="flex flex-col gap-1.5">
                                    <label class="text-[11px] font-bold text-slate-500 uppercase tracking-[.1em]">No.
                                        Telepon</label>
                                    <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" required
                                        class="py-[10px] px-[13px] bg-slate-50 border-[1.5px] border-slate-200 rounded-[11px] text-[13.5px] outline-none transition-all duration-200 focus:border-[#0f766e] focus:bg-white focus:shadow-[0_0_0_3px_rgba(15,118,110,0.08)] @error('phone') border-red-400 @enderror" />
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                                <div class="flex flex-col gap-1.5">
                                    <label class="text-[11px] font-bold text-slate-500 uppercase tracking-[.1em]">Password
                                        Baru</label>
                                    <div class="relative">
                                        <input type="password" name="password" id="new-pass" required minlength="8"
                                            class="w-full py-[10px] px-[13px] pr-10 bg-slate-50 border-[1.5px] border-slate-200 rounded-[11px] text-[13.5px] outline-none transition-all duration-200 focus:border-[#0f766e] focus:bg-white focus:shadow-[0_0_0_3px_rgba(15,118,110,0.08)]" />
