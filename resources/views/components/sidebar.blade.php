...
<aside class="w-[260px] min-w-[260px] bg-white border-r border-slate-200 flex flex-col px-5 py-9 h-screen">
    ...
    <!-- Navigation -->
    <nav class="nav-scroll flex flex-col gap-0.5 flex-1 overflow-y-auto" aria-label="Main navigation">
        ...
        @if($isAdmin)
            <a href="{{ route('admin.dashboard') }}"
                ...
                <i class="ri-dashboard-fill text-[17px]" aria-hidden="true"></i> Dashboard
            </a>
            ...
            <a href="{{ route('admin.admins.index') }}"
                ...
                <i class="ri-user-star-line text-[17px]" aria-hidden="true"></i> Admin
            </a>
            ...
            <a href="{{ route('admin.orders.index') }}"
                ...
                <i class="ri-file-list-3-line text-[17px]" aria-hidden="true"></i> Orders
            </a>
            ...
            <a href="{{ route('admin.reviews.index') }}"
                ...
                <i class="ri-star-line text-[17px]" aria-hidden="true"></i> Reviews
            </a>
            ...
            <a href="{{ route('admin.services.index') }}"
                ...
                <i class="ri-tools-line text-[17px]" aria-hidden="true"></i> Services
            </a>
            ...
            <a href="{{ route('admin.transactions.index') }}"
                ...
                <i class="ri-bank-card-line text-[17px]" aria-hidden="true"></i> Transactions
            </a>
        ...
        @if($isClient)
            ...
            <a href="{{ route('client.talents.index') }}" class="flex items-center gap-[11px] px-[14px] py-[11px] rounded-[11px] font-semibold text-[13.5px] transition-all duration-200
                ...
                <i class="ri-user-search-line text-[17px]" aria-hidden="true"></i> Find Talent
            </a>
            ...
            <a href="{{ route('client.messages.index') }}" class="flex items-center gap-[11px] px-[14px] py-[11px] rounded-[11px] font-semibold text-[13.5px] transition-all duration-200
                ...
                <i class="ri-message-3-line text-[17px]" aria-hidden="true"></i> Messages
            </a>
            ...
            <a href="{{ route('client.payments.index') }}" class="flex items-center gap-[11px] px-[14px] py-[11px] rounded-[11px] font-semibold text-[13.5px] transition-all duration-200
                ...
                <i class="ri-bank-card-line text-[17px]" aria-hidden="true"></i> Payment
            </a>
        ...
        <nav class="flex flex-col gap-0.5">
            ...
            @if($settingsRoute && Route::has($settingsRoute))
                <a href="{{ route($settingsRoute) }}"
                    ...
                    aria-label="Settings">
                    <i class="ri-settings-3-line text-[17px]" aria-hidden="true"></i> Settings
                </a>
            @endif
            ...
            @if($accountRoute && Route::has($accountRoute))
                <a href="{{ route($accountRoute) }}"
                    ...
                    aria-label="Account">
                    <i class="ri-user-line text-[17px]" aria-hidden="true"></i> Account
                </a>
            @endif
            ...
            <button type="button"
                ...
                aria-label="Logout">
                <i class="ri-logout-box-line text-[17px]" aria-hidden="true"></i> Logout
            </button>
